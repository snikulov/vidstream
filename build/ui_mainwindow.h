...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        reorderCheckBox = new QCheckBox(centralWidget);
        reorderCheckBox->setObjectName(QStringLiteral("reorderCheckBox"));

        horizontalLayout_3->addWidget(reorderCheckBox);

        bandwidthSpinBox = new QSpinBox(centralWidget);
        bandwidthSpinBox->setObjectName(QStringLiteral("bandwidthSpinBox"));
        bandwidthSpinBox->setMinimum(1);
        bandwidthSpinBox->setMaximum(2000000000);
        bandwidthSpinBox->setValue(1000000000);

        horizontalLayout_3->addWidget(bandwidthSpinBox);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        recordButton->setText(QApplication::translate("MainWindow", "Compile Video", 0));
        ...
        reorderCheckBox->setText(QApplication::translate("MainWindow", "Reorder blocks", 0));
        bandwidthSpinBox->setSuffix(QApplication::translate("MainWindow", " bytes/s", 0));
