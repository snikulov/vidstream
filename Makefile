#############################################################################
# Makefile for building: corrupt
# Generated by qmake (3.0) (Qt 5.0.1) on: ?? ????? 16 17:58:09 2014
# Project:  ../noencode/Corrupt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ../noencode/Corrupt.pro
#############################################################################
...
CFLAGS        = -m64 -pipe -O3 -g -Wall -W -D_REENTRANT -fPIE $(DEFINES)
CXXFLAGS      = -m64 -pipe -O3 -DGENERATE_HEADER -g -std=c++11 -Wno-write-strings -g -Wall -W -D_REENTRANT -fPIE $(DEFINES)
INCPATH       = -I/usr/share/qt5/mkspecs/linux-g++-64 -I../noencode -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I. -I.
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -ljpeg -lavcodec -lavformat -lavdevice -lavutil -lswscale -lrt -lQt5Widgets -L/usr/lib/x86_64-linux-gnu -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = ../noencode/main.cpp \
		../noencode/mainwindow.cpp \
		../noencode/bch.cpp \
		../noencode/corrupt.cpp \
		../noencode/ecc.cpp \
		../noencode/receiverthread.cpp \
		../noencode/restartblock.cpp \
		../noencode/senderthread.cpp \
		../noencode/split.cpp \
		../noencode/jpegops.cpp \
		../noencode/statcollector.cpp \
		../noencode/settingsdialog.cpp \
		../noencode/bitmap.cpp \
		../noencode/avhandler.cpp \
		../noencode/interlace.cpp moc_mainwindow.cpp \
...
DIST          = /usr/share/qt5/mkspecs/features/spec_pre.prf \
		...
		../noencode/Corrupt.pro \
		../noencode/Corrupt.pro
QMAKE_TARGET  = corrupt
DESTDIR       = 
TARGET        = corrupt
...
Makefile: ../noencode/Corrupt.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile ../noencode/Corrupt.pro
...
dist: 
	@test -d .tmp/corrupt1.0.0 || $(MKDIR) .tmp/corrupt1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/corrupt1.0.0/ && $(COPY_FILE) --parents ../noencode/mainwindow.h ../noencode/bch.h ../noencode/corrupt.h ../noencode/ecc.h ../noencode/membuf.h ../noencode/receiverthread.h ../noencode/restartblock.h ../noencode/senderthread.h ../noencode/split.h ../noencode/jpegops.h ../noencode/statcollector.h ../noencode/settingsdialog.h ../noencode/bitmap.h ../noencode/avhandler.h ../noencode/interlace.h ../noencode/queue_params.h .tmp/corrupt1.0.0/ && $(COPY_FILE) --parents ../noencode/main.cpp ../noencode/mainwindow.cpp ../noencode/bch.cpp ../noencode/corrupt.cpp ../noencode/ecc.cpp ../noencode/receiverthread.cpp ../noencode/restartblock.cpp ../noencode/senderthread.cpp ../noencode/split.cpp ../noencode/jpegops.cpp ../noencode/statcollector.cpp ../noencode/settingsdialog.cpp ../noencode/bitmap.cpp ../noencode/avhandler.cpp ../noencode/interlace.cpp .tmp/corrupt1.0.0/ && $(COPY_FILE) --parents ../noencode/mainwindow.ui ../noencode/settingsdialog.ui .tmp/corrupt1.0.0/ && (cd `dirname .tmp/corrupt1.0.0` && $(TAR) corrupt1.0.0.tar corrupt1.0.0 && $(COMPRESS) corrupt1.0.0.tar) && $(MOVE) `dirname .tmp/corrupt1.0.0`/corrupt1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/corrupt1.0.0
...
moc_mainwindow.cpp: ../noencode/bitmap.h \
		../noencode/ecc.h \
		../noencode/bch.h \
		../noencode/interlace.h \
		../noencode/receiverthread.h \
		...
		../noencode/restartblock.h \
		../noencode/statcollector.h \
		...
		../noencode/mainwindow.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) ../noencode/mainwindow.h -o moc_mainwindow.cpp
...
moc_settingsdialog.cpp: /usr/include/qt5/QtWidgets/QDialog \
		...
		/usr/include/qt5/QtGui/qvector2d.h \
		/usr/include/qt5/QtGui/qtouchdevice.h \
		../noencode/settingsdialog.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) ../noencode/settingsdialog.h -o moc_settingsdialog.cpp
...
ui_mainwindow.h: ../noencode/mainwindow.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic ../noencode/mainwindow.ui -o ui_mainwindow.h

ui_settingsdialog.h: ../noencode/settingsdialog.ui
	/usr/lib/x86_64-linux-gnu/qt5/bin/uic ../noencode/settingsdialog.ui -o ui_settingsdialog.h
...
main.o: ../noencode/main.cpp ../noencode/mainwindow.h \
		../noencode/bitmap.h \
		../noencode/ecc.h \
		../noencode/bch.h \
		../noencode/interlace.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o ../noencode/main.cpp

mainwindow.o: ../noencode/mainwindow.cpp ../noencode/mainwindow.h \
		../noencode/bitmap.h \
		../noencode/ecc.h \
		../noencode/bch.h \
		../noencode/interlace.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o mainwindow.o ../noencode/mainwindow.cpp

bch.o: ../noencode/bch.cpp ../noencode/bch.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o bch.o ../noencode/bch.cpp

corrupt.o: ../noencode/corrupt.cpp ../noencode/corrupt.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o corrupt.o ../noencode/corrupt.cpp

ecc.o: ../noencode/ecc.cpp ../noencode/ecc.h \
		../noencode/bch.h \
		../noencode/statcollector.h \
		/usr/include/qt5/QtCore/QDebug \
		/usr/include/qt5/QtCore/qdebug.h \
		...
		/usr/include/qt5/QtCore/qset.h \
		/usr/include/qt5/QtCore/qcontiguouscache.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ecc.o ../noencode/ecc.cpp

receiverthread.o: ../noencode/receiverthread.cpp ../noencode/receiverthread.h \
		/usr/include/qt5/QtCore/QThread \
		/usr/include/qt5/QtCore/qthread.h \
		/usr/include/qt5/QtCore/qobject.h \
		/usr/include/qt5/QtCore/qobjectdefs.h \
		...
		../noencode/membuf.h \
		../noencode/split.h \
		../noencode/queue_params.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o receiverthread.o ../noencode/receiverthread.cpp

restartblock.o: ../noencode/restartblock.cpp ../noencode/restartblock.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o restartblock.o ../noencode/restartblock.cpp

senderthread.o: ../noencode/senderthread.cpp ../noencode/senderthread.h \
		/usr/include/qt5/QtCore/QThread \
		/usr/include/qt5/QtCore/qthread.h \
		/usr/include/qt5/QtCore/qobject.h \
		/usr/include/qt5/QtCore/qobjectdefs.h \
		...
		../noencode/split.h \
		../noencode/queue_params.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o senderthread.o ../noencode/senderthread.cpp

split.o: ../noencode/split.cpp ../noencode/split.h \
		/usr/include/qt5/QtCore/QDebug \
		/usr/include/qt5/QtCore/qdebug.h \
		/usr/include/qt5/QtCore/qalgorithms.h \
		/usr/include/qt5/QtCore/qglobal.h \
		...
		/usr/include/qt5/QtGui/qicon.h \
		../noencode/corrupt.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o split.o ../noencode/split.cpp

jpegops.o: ../noencode/jpegops.cpp ../noencode/jpegops.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o jpegops.o ../noencode/jpegops.cpp

statcollector.o: ../noencode/statcollector.cpp ../noencode/statcollector.h \
		/usr/include/qt5/QtCore/QDebug \
		/usr/include/qt5/QtCore/qdebug.h \
		/usr/include/qt5/QtCore/qalgorithms.h \
		/usr/include/qt5/QtCore/qglobal.h \
		...
		/usr/include/qt5/QtCore/qset.h \
		/usr/include/qt5/QtCore/qcontiguouscache.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o statcollector.o ../noencode/statcollector.cpp

settingsdialog.o: ../noencode/settingsdialog.cpp ../noencode/settingsdialog.h \
		/usr/include/qt5/QtWidgets/QDialog \
		/usr/include/qt5/QtWidgets/qdialog.h \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
		...
		/usr/include/qt5/QtWidgets/QMessageBox \
		/usr/include/qt5/QtWidgets/qmessagebox.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o settingsdialog.o ../noencode/settingsdialog.cpp

bitmap.o: ../noencode/bitmap.cpp ../noencode/bitmap.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o bitmap.o ../noencode/bitmap.cpp

avhandler.o: ../noencode/avhandler.cpp ../noencode/avhandler.h \
		/usr/include/qt5/QtGui/QImageIOHandler \
		/usr/include/qt5/QtGui/qimageiohandler.h \
		/usr/include/qt5/QtCore/qplugin.h \
		/usr/include/qt5/QtCore/qobject.h \
		...
		/usr/include/qt5/QtCore/qset.h \
		/usr/include/qt5/QtCore/qcontiguouscache.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o avhandler.o ../noencode/avhandler.cpp

interlace.o: ../noencode/interlace.cpp ../noencode/interlace.h \
		../noencode/bitmap.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o interlace.o ../noencode/interlace.cpp
